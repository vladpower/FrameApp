...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.remove_pb = QtWidgets.QPushButton(self.groupBox_5)
        self.remove_pb.setObjectName("remove_pb")
        self.verticalLayout_13.addWidget(self.remove_pb)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.groupBox_7.setTitle(_translate("MainWindow", "Добавить"))
