...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.getAll_pb = QtWidgets.QPushButton(self.groupBox_5)
        self.getAll_pb.setObjectName("getAll_pb")
        self.verticalLayout_11.addWidget(self.getAll_pb)
        ...
        self.task_le = QtWidgets.QLineEdit(self.groupBox_7)
        self.task_le.setObjectName("task_le")
        self.horizontalLayout_6.addWidget(self.task_le)
        ...
        self.nameTask_le = QtWidgets.QLineEdit(self.groupBox_8)
        self.nameTask_le.setObjectName("nameTask_le")
        self.horizontalLayout_8.addWidget(self.nameTask_le)
        self.verticalLayout_5.addLayout(self.horizontalLayout_8)
        self.addTask_pb = QtWidgets.QPushButton(self.groupBox_8)
        self.addTask_pb.setObjectName("addTask_pb")
        self.verticalLayout_5.addWidget(self.addTask_pb)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.groupBox_7.setTitle(_translate("MainWindow", "Добавить алгоритм"))
        self.label_4.setText(_translate("MainWindow", "Название"))
        self.label_5.setText(_translate("MainWindow", "Задача"))
        self.addAlg_pb.setText(_translate("MainWindow", "Добавить"))
        self.groupBox_8.setTitle(_translate("MainWindow", "Добавить задачу"))
        self.label_6.setText(_translate("MainWindow", "Название"))
        self.addTask_pb.setText(_translate("MainWindow", "Добавить"))
